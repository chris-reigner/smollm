...
Applied end-to-end notebooks from the SmolLM series that pair with this module:

| Notebook | Description |
|----------|-------------|
| [1. SmolLM Family](./notebooks/1.%20SmolLM%20Family.ipynb) | Tour of the SmolLM2 model family and loading/running the base models |
| [2. SmolLM text summarization](./notebooks/2.%20SmolLM%20text%20summarization.ipynb) | Supervised fine-tuning of SmolLM2 on a summarization task |
